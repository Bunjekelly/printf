...
* @ind: index from which a number begins from buffer array
* @buffer: buffer array
* @flags: active flags specifier
* @width: width specifier
...
* @is_negative: indicates if a number is negative
* @ind: index indicating the beginning of a number in buffer array
* @buffer: Buffer array
* @flags: active flags specifier
* @width: width specifier
* @precision: precision specifier
...
* @buffer: buffer array
* @ind: index from which a number begins in the buffer array
